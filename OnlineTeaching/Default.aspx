    ...
    <div id="top">
        ...
        <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" Width="100%" 
            ...
            <Items>
                ...
                <asp:MenuItem Text="Student Registration" Value="REGISTRATION" 
                ...
                <asp:MenuItem Text="Our Teachers" Value="STAFF REPORT" 
                    NavigateUrl="~/StaffReport.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Downloads" Value="VIDEO" NavigateUrl="~/Download.aspx"></asp:MenuItem>
                <asp:MenuItem Text="Admin Login" Value="LOGIN" NavigateUrl="~/Admin/Default.aspx"></asp:MenuItem>
...
<a href="#"><img src="data1/images/2.jpg" alt="" title="" id="wows1"/></a>
<a href="#"><img src="data1/images/3.jpg" alt="" title="" id="wows2"/></a>
<a href="#"><img src="data1/images/4.jpg" alt="" title="" id="wows3"/></a>
<a href="#"><img src="data1/images/9.jpg" alt="" title="" id="wows4"/></a>
<a href="#"><img src="data1/images/6.jpg" alt="" title="" id="wows5"/></a>
<a href="#"><img src="data1/images/7.jpg" alt="" title="" id="wows6"/></a>
</div>
<div class="ws_bullets"><div>
<a href="#wows0" title=""><img src="data1/tooltips/1.jpg" alt=""/>1</a>
<a href="#wows1" title=""><img src="data1/tooltips/2.jpg" alt=""/>2</a>
<a href="#wows2" title=""><img src="data1/tooltips/3.jpg" alt=""/>3</a>
<a href="#wows3" title=""><img src="data1/tooltips/4.jpg" alt=""/>4</a>
<a href="#wows4" title=""><img src="data1/tooltips/9.jpg" alt=""/>5</a>
<a href="#wows5" title=""><img src="data1/tooltips/6.jpg" alt=""/>6</a>
<a href="#wows6" title=""><img src="data1/tooltips/7.jpg" alt=""/>7</a>
</div></div>
<a style="display:none" href="http://wowslider.com">Script Image Slider by WOWSlider.com v1.7</a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=SCROLL><span class="log"> Welcome to Oman Technology Institute's Knowledge Academy! Get Ready to Unleash Your Full Potential!</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;">© 2023 Oman Technology Institute. All Rights Reserved.</div>
    </form>
</body>
</html>
